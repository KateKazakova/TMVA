...
namespace HZG {
  ...
  ///new static object
    ...
    ///new functions for BDTG and MLP responses
...
///  setting variable for MLP method
	void Object_llg::SetMVA1()
	{
		...
		_ptr1->reader->AddVariable("llg_angles_costheta_ginH_Zmassconstraint", &(_ptr1->Map_float)["llg_angles_costheta_ginH__Zmassconstraint"]);
		_ptr1->reader->AddVariable("llg_dphi_Zy_Zmassconstraint", &(_ptr1->Map_float)["llg_dphi_Zy_Zmassconstraint"]);
		_ptr1->reader->AddVariable("ll_m_fsr", &(_ptr1->Map_float)["ll_m_fsr"]);
		_ptr1->reader->AddVariable("llg_angles_costheta_linZ_Zmassconstraint", &(_ptr1->Map_float)["llg_angles_costheta_linZ_Zmassconstraint"]);
...
/// setting variables for BDTG method
	void Object_llg::SetMVA2()
	{
		...
		_ptr2->reader->AddVariable("llg_angles_costheta_ginH_Zmassconstraint", &(_ptr2->Map_float)["llg_angles_costheta_ginH_Zmassconstraint"]);
		_ptr2->reader->AddVariable("llg_deta_Zy_Zmassconstraint", &(_ptr2->Map_float)["llg_deta_Zy_Zmassconstraint"]);
		_ptr2->reader->AddVariable("llg_dphi_Zy_Zmassconstraint", &(_ptr2->Map_float)["llg_dphi_Zy_Zmassconstraint"]);
		_ptr2->reader->AddVariable("llg_angles_costheta_linZ_Zmassconstraint", &(_ptr2->Map_float)["llg_angles_costheta_linZ_Zmassconstraint"]);
...
/// setting postfix for MLP
	void Object_llg::SetMVAVars1(TString postfix)
	{
		...
		(_ptr1->Map_float)["llg_angles_costheta_ginH_Zmassconstraint"] = Map_float[(TString)"llg_angles_costheta_ginH"+postfix] ;
		(_ptr1->Map_float)["llg_dphi_Zy_Zmassconstraint"] = Map_float[(TString)"llg_dphi_Zy"+postfix] ;
		(_ptr1->Map_float)["ll_m_fsr"] = Map_float[(TString)"ll_m_fsr"] ;
		(_ptr1->Map_float)["llg_angles_costheta_linZ_Zmassconstraint"] = Map_float[(TString)"llg_angles_costheta_linZ"+postfix] ;
	...
	/// setting postfix for BDTG
		void Object_llg::SetMVAVars2(TString postfix)
		{
			...
			(_ptr2->Map_float)["llg_angles_costheta_ginH_Zmassconstraint"] = Map_float[(TString)"llg_angles_costheta_ginH"+postfix] ;
			(_ptr2->Map_float)["llg_deta_Zy_Zmassconstraint"] = Map_float[(TString)"llg_deta_Zy"+postfix] ;
			(_ptr2->Map_float)["llg_dphi_Zy_Zmassconstraint"] = Map_float[(TString)"llg_dphi_Zy"+postfix] ;
			(_ptr2->Map_float)["llg_angles_costheta_linZ_Zmassconstraint"] = Map_float[(TString)"llg_angles_costheta_linZ"+postfix] ;
...
///function for BDTG metod N_jet >=2
	...
	void Object_llg::ComputeAdditionalQuantities(TLorentzVector &p_ph, TLorentzVector &p_lepton1, TLorentzVector &p_lepton2, TString postfix)
	{
		...
		float MLPOUT = GetMVAResponse1();
		Map_float["MLP_FINAL"] = MLPOUT;
                float BDTGOUT = GetMVAResponse2();
                Map_float["BDTG_FINAL"] = BDTGOUT;
